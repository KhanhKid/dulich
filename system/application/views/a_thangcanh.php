<div id="content-wapper-main">
	...
	<div class="pathway-news">
     			...
     			<div itemscope=""  class="no-bg"><a href="/a/thangcanh" itemprop="url" class="homepage"><span itemprop="title">THẮNG CẢNH</span></a></div>
		...
		<ul class="list-items">
            ...
            ?>
                <li>
                    <p class="img">
                        <a href="/i/place/<?php echo $value->ID ?>">
                            <img src="/img/imgplace/<?php echo $value->img ?>" width="180" alt="<?php echo $value->title ?>"></a>
                    </p>
                    <div class="info-items">
                        <p class="name">
                            <a href="/i/place/<?php echo $value->ID ?>"><?php echo $value->title ?></a>
                        </p>
