...
<div id="left-tour">
	...
	<div class="content-de-tour">
				<div class="photo">
            <img src="<?php echo $data->img?>" width="340" alt="<?php echo $data->name; ?>">
        </div>

                <div class="info-tour-de">

                	<p class="name"><span class="tour"><?php echo $data->name; ?></span> - <span>Mã tour</span>: SRTST<?php echo $data->ID; ?></p>
