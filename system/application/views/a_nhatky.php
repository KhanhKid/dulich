<div id="content-wapper-main">
	...
	<div class="pathway-news">
     			...
     			<div itemscope=""  class="no-bg"><a href="/a/nhatky" itemprop="url" class="homepage"><span itemprop="title">NHẬT KÝ DU LỊCH TOUR</span></a></div>
		...
		<ul class="list-items">
            ...
            ?>
                <li>
                    <p class="img">
                        <a href="/i/dairy/<?php echo $value->ID ?>">
                            <img src="/img/imgdairy/<?php echo $value->img ?>" width="180" alt="<?php echo $value->title ?>"></a>
                    </p>
